...
class WordListFragment : Fragment() {
    ...
    // DetailActivity.<variable> without needing to create a DetailActivity instance.
    companion object {
        const val LETTER = "letter"
        const val SEARCH_PREFIX = "https://www.google.com/search?q="
    }

    // Accessing safe arguments, you dont have to wait until onViewCreated() is called
