...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        var listItemLayout: Int = if (layout == Layout.HORIZONTAL || layout == Layout.VERTICAL) {
            Log.d("ANDYYY", "vertical_horizontal_list_item")
            R.layout.vertical_horizontal_list_item
        } else {
            Log.d("ANDYYY", "grid_list_item")
        ...
        // TODO: Null should not be passed into the view holder.
