...
class FullScheduleFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // submitList() is a call that accesses the database. To prevent the call from potentially
        // locking the UI, you should use a coroutine scope to launch the function.
