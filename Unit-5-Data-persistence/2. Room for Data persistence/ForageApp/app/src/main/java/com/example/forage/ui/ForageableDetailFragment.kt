...
class ForageableDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 11. Observe a forageable that is retrieved by id, set the forageable variable, and call the bind forageable method
        viewModel.getForageableById(id).observe(this.viewLifecycleOwner, { retrievedForageable ->
            this.forageable = retrievedForageable
            bindForageable()
        })
    }
