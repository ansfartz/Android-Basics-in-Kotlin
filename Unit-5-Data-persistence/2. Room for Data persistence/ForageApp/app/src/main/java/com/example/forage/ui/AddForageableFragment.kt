...
class AddForageableFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (id > 0) {
            ...
            // 11. Observe a Forageable that is retrieved by id, set the forageable variable
            // and call the bindForageable method
            viewModel.getForageableById(id).observe(this.viewLifecycleOwner, { retrieverForageable ->
                forageable = retrieverForageable
