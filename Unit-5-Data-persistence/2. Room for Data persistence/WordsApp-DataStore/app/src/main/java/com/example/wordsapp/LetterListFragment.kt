    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_switch_layout -> {
                ...
                // This must be done asynchronously inside a coroutine.
                // To perform this inside a fragment, use the CoroutineScope called LifecycleScope.
                lifecycleScope.launch {
                    SettingsDataStore.saveBooleanToPreferencesStore(isLinearLayoutManager, requireContext())
                }
